...
| Device is in recovery mode. Connect to `squeezelite-299fac` wifi network with `squeezelite` password | ![image](https://github.com/sonocotta/esp32-audio-dock/assets/5459747/2763663c-dbc9-4c71-af12-0a6fb9c2d94d) |
...
| Navigate to hardware section and provide following updates <br/> DAC model: `I2S` <br/> Clock GPIO: `26` <br/> Word Select GPIO: `25` <br/> Data GPIO: `22` |  ![image](https://github.com/sonocotta/esp32-audio-dock/assets/5459747/f52e3a05-abe6-40d7-98ac-212bff6c431f)
| (Louder ESP only) | tbd
| Press `Save` button and Exit recovery | ![image](https://github.com/sonocotta/esp32-audio-dock/assets/5459747/c54b18fa-c995-4e67-bced-820f8bce5fe6)
