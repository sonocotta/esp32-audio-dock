...
- [ESP32 Audio Docks and Louder ESP](#esp32-audio-docks-and-louder-esp)
  ...
  - [Hardware](#hardware)
    ...
    - [BTL and PBTL mode (Louder and Amped boards)](#btl-and-pbtl-mode-louder-and-amped-boards)
      ...
      - [Louder-ESP32 and Louder-ESP32-Plus (recent revisions)](#louder-esp32-and-louder-esp32-plus-recent-revisions)
...
All ESPHome configurations are in the [firmware/esphome/](firmware/esphome/) folder. See the **[ESPHome README](firmware/esphome/README.md)** for full details on supported hardware variants, configuration options, the package system, and build instructions.
...
| Sendspin | `*-sendspin.yaml` | ESPHome-native multi-room playback via [Sendspin protocol](https://www.music-assistant.io/player-support/sendspin/) (experimental, 2026.2.0+) |
...
While the 55mm variant has a [Hynetek HUSB238](https://www.hynetek.com/uploadfiles/site/219/news/aabbbbdb-48c9-4a44-a6dc-2c15f53282e6.pdf) USB-PD trigger chip, capable of pulling more power from the PD-enabled power adapters (most commonly modern laptop power adapters), there are certain limitations to the way it can be used.
...
The default mode of operation of the Louder-ESP32-Mini (55mm) is "Smart" mode, which requires an I2C driver that actively sets the required voltage on start. The ESPhome driver is currently in development ([PR6693](https://github.com/esphome/esphome/pull/6693) and [PR16572](https://github.com/esphome/esphome/pull/16572)) and might be available in the near future, but not today.
...
<img width="915" height="635" alt="image" src="https://github.com/user-attachments/assets/6ee621e5-6486-45ed-9ca5-e0ad664559b2" />
...
- Loud-ESP32-Plus at [Lectronz](https://lectronz.com/products/loud-esp32-plus), Elecrow (coming soon), and [Tindie](https://www.tindie.com/products/sonocotta/loud-esp32-plus/)
...
- Louder-ESP32-Mini at [Lectronz](https://lectronz.com/products/louder-esp32-mini), [Elecrow](https://www.elecrow.com/louder-esp32-mini.html), and [Tindie](https://www.tindie.com/products/sonocotta/louder-esp32-mini/)
